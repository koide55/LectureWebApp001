...
- 回答形式: 作文
- 文字数目安: 80-150字
- 必ず書くこと: 1. `alice` の結果 2. `admin` の結果 3. どこで制御しているか
...
- 回答形式: 選択肢または作文
- Moodle推奨: 各機能ごとに1つ選ぶ組合せ問題
- 必ず答えること: 6つの対象すべてを1つずつ分類する
...
- 回答形式: 選択肢または作文
- Moodle推奨: 対策名と問題名を結ぶ組合せ問題
- 必ず答えること: 各対策が主に対応する脆弱性を1つずつ書く
...
- 回答形式: 作文またはファイル提出
- 文字数目安: 200-300字
- 必ず書くこと: 1. 追加ページ名 2. 必要ロール 3. 保護方法 4. 想定脆弱性と対策
