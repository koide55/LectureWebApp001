...
- 回答形式: 提出不要
- 教員が回収する場合のみ: 「起動できたか」と「開いたページ名」を1-2文で書く
...
- 回答形式: 作文
- 文字数目安: 40-80字
- 必ず書くこと: 1. 起動できたか 2. 開いたURL 3. エラーが出た場合はその内容
...
- 回答形式: 作文
- 文字数目安: 100-180字
- 必ず書くこと: 各URLについて関数名、HTTPメソッド、テンプレート名
...
- 回答形式: 作文
- 文字数目安: 80-150字
- 必ず書くこと: 1. ログイン前の結果 2. ログイン後の結果 3. 差が生まれる理由
